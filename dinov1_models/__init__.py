...
def dino_vits8(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        # model.load_state_dict(state_dict, strict=True)
        # qkv_weights_before = model.blocks[0].attn.qkv
        # print("before:")
        # for name, param in qkv_weights_before.named_parameters():
        #     print(f"Parameter: {name}")
        #     print(param)  # Prints the full tensor
        model.load_state_dict(state_dict, strict=False)
        # qkv_weights_after = model.blocks[0].attn.qkv
        # print("after: ", )
        # print("before:")
        # for name, param in qkv_weights_after.named_parameters():
        #     print(f"Parameter: {name}")
        #     print(param)  # Prints the full tensor
        lora.mark_only_lora_as_trainable(model)
        # qkv_weight_diff = qkv_weights_after - qkv_weights_before
        # print("weight diff: ", qkv_weight_diff.sum())
    return model
